...
async function loadCoefficient() {
  const res = await fetch('http://localhost:8080/api/admin/coefficient')
...
async function saveCoefficient() {
  try {
    const res = await fetch(`http://localhost:8080/api/admin/coefficient/update`, {
      method: "PUT",
...
async function saveEmployees() {
  try {
    const res = await fetch(`http://localhost:8080/api/admin/employees/update`, {
      method: "PUT",
      headers: { 'Content-Type': 'application/json' },
...
async function saveEmployer() {
  try {
    const res = await fetch(`http://localhost:8080/api/admin/employees/save`, {
      method: "POST",
      headers: { 'Content-Type': 'application/json' },
